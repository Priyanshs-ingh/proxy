...
var _AcquiredCompany = _interopRequireDefault(require("./AcquiredCompany"));
var _AcquisitionAcquiredBy = _interopRequireDefault(require("./AcquisitionAcquiredBy"));
  ...
  _createClass(Acquisition, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('acquired')) {
          obj['acquired'] = _ApiClient["default"].convertToType(data['acquired'], [_AcquiredCompany["default"]]);
        }
        if (data.hasOwnProperty('acquired_by')) {
          obj['acquired_by'] = _AcquisitionAcquiredBy["default"].constructFromObject(data['acquired_by']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      if (data['acquired']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['acquired']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _AcquiredCompany["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['acquired_by']) {
        // data not null
        _AcquisitionAcquiredBy["default"].validateJSON(data['acquired_by']);
      }
      return true;
    }
  }]);
